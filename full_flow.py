...
async def main():
    print("=" * 60)
    print("full_flow.py - Amazon Seller Sprite Export (批量版)")
    print("=" * 60)
    ...
    for keyword in keywords:
        ...
        async with websockets.connect(WS_URL) as ws:
            ...
            # Step 1: Open new tab
            print("\n[1/6] 🌐 打开新标签页")
            r = await cmd('new_tab', url=f'https://www.amazon.com/s?k={keyword}', active=True)
            tab_id = r['tab_id']
            ...
            print(f"✅ 卖家精灵点击结果: {r}")
            print("⏳ 等待 卖家精灵 注入数据...")
            await asyncio.sleep(12)  # 等待12秒让卖家精灵注入数据
